...
packages_list = find_packages(include=["ctta", "ctta.*"])

## additional data to install
packages_data: Dict[str, Any] = {"ctta": []}
...
setup(
    name="ctta",
    version="1.0.1",
    description="analyze clang time-trace JSONs",
    url="https://github.com/anetczuk/clang-time-trace-analyzer",
